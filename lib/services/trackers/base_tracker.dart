...
class OAuthCredentials {
  ...
  /// Set after the first profile fetch; mutable by design.
  String? userId;
...
abstract class Tracker {
  ...
  /// Protected access to the credential cache for subclasses. (Dart private
  /// fields are library-private — subclasses in other files cannot see
  /// `_credentials`, which is exactly how the skeleton broke.)
  @protected
  OAuthCredentials? get protectedCredentials => _credentials;

  @protected
  set protectedCredentials(OAuthCredentials? value) => _credentials = value;

  /// Protected access to the token cipher for subclasses.
  @protected
  TokenCipher? get protectedCipher => _cipher;
