...
class BackupService {
  ...
  Future<Map<String, dynamic>> _buildPayload(BackupOptions options) async {
    final payload = <String, dynamic>{
      ...
      'schema': <String, dynamic>{
        // Collection names (kept as plain strings — the previous code called
        // `toString()` on the type objects, which is not valid Dart).
        'manga': 'Manga',
        'chapter': 'Chapter',
        'note': 'Note',
  ...
  static History _historyFromJson(Map<String, dynamic> json) {
    return History(
      ...
      mediaType: _enumByNameOrNull<HistoryMediaType>(HistoryMediaType.values, json['mediaType'] as String?),
  ...
  static Category _categoryFromJson(Map<String, dynamic> json) => Category(
        ...
        name: json['name'] as String? ?? '',
        position: (json['position'] as num?)?.toInt(),
        type: _enumByNameOrNull<CategoryType>(CategoryType.values, json['type'] as String?),
        ...
        displayMode: _enumByNameOrNull<CategoryDisplayMode>(CategoryDisplayMode.values, json['displayMode'] as String?),
  ...
  static Track _trackFromJson(Map<String, dynamic> json) => Track(
        ...
        mangaId: json['mangaId'] as int?,
        mangaIdString: json['mangaIdString'] as String?,
        syncId: _enumByNameOrNull<TrackerSyncId>(TrackerSyncId.values, json['syncId'] as String?),
        ...
        status: _enumByNameOrNull<TrackStatus>(TrackStatus.values, json['status'] as String?),
        ...
        isSynced: json['isSynced'] as bool?,
        metadataJson: json['metadataJson'] as String?,
        mediaType: _enumByNameOrNull<TrackMediaType>(TrackMediaType.values, json['mediaType'] as String?),
        sourceId: json['sourceId'] as String?,
      );
