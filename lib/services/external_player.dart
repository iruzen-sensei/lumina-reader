...
class ExternalPlayerService {
  ...
  Future<ExternalPlayerResult> _awaitResult(ExternalPlayer player) async {
    ...
    // Note: [MethodChannel.setMethodCallHandler] is synchronous and returns
    // no previous handler in current Flutter — we simply own the channel for
    // the duration of the playback and clear it afterwards.
    _kChannel.setMethodCallHandler(
