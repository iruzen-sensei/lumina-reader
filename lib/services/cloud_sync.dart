...
class CloudSyncService {
  ...
  StreamSubscription<QuerySnapshot<Map<String, dynamic>>> _subscribe(
    SyncCollection collection, {
    required Future<void> Function(DocumentSnapshot<Map<String, dynamic>> doc) apply,
  }) {
    return _firestore
        .collection(_collectionPath(collection))
      ...
      (snapshot) async {
        for (final change in snapshot.docChanges) {
          ...
          if (data != null &&
              data['deviceId'] == dataSource.deviceId &&
  ...
  Future<void> _applyLibrary(DocumentSnapshot<Map<String, dynamic>> doc) async {
  ...
  Future<void> _applyNote(DocumentSnapshot<Map<String, dynamic>> doc) async {
    final remote = doc.data();
    if (remote == null) return;
  ...
  Future<void> _applySession(DocumentSnapshot<Map<String, dynamic>> doc) async {
    final remote = doc.data();
    if (remote == null) return;
    await dataSource.upsertSession(_sessionFromMap(remote));
  }

  Future<void> _applyHistory(DocumentSnapshot<Map<String, dynamic>> doc) async {
    final remote = doc.data();
    if (remote == null) return;
  ...
  Future<void> _applyCategory(DocumentSnapshot<Map<String, dynamic>> doc) async {
    final remote = doc.data();
    if (remote == null) return;
    await dataSource.upsertCategory(_categoryFromMap(remote));
  }

  Future<void> _applyTrack(DocumentSnapshot<Map<String, dynamic>> doc) async {
    final remote = doc.data();
    if (remote == null) return;
  ...
  Future<void> _applySettings(DocumentSnapshot<Map<String, dynamic>> doc) async {
    final remote = doc.data();
    if (remote == null) return;
  ...
  static History _historyFromMap(Map<String, dynamic> map) => History(
        ...
        mediaType: _enumByNameOrNull(HistoryMediaType.values, map['mediaType'] as String?),
  ...
  static Category _categoryFromMap(Map<String, dynamic> map) => Category(
        ...
        name: map['name'] as String? ?? '',
        position: (map['position'] as num?)?.toInt(),
        type: _enumByNameOrNull(CategoryType.values, map['type'] as String?),
        ...
        displayMode: _enumByNameOrNull(
            CategoryDisplayMode.values, map['displayMode'] as String?),
  ...
  static Track _trackFromMap(Map<String, dynamic> map) => Track(
        ...
        mangaId: (map['mangaId'] as num?)?.toInt(),
        mangaIdString: map['mangaIdString'] as String?,
        syncId: _enumByNameOrNull(TrackerSyncId.values, map['syncId'] as String?),
        ...
        status: _enumByNameOrNull(TrackStatus.values, map['status'] as String?),
        ...
        metadataJson: map['metadataJson'] as String?,
        mediaType:
            _enumByNameOrNull(TrackMediaType.values, map['mediaType'] as String?),
        sourceId: map['sourceId'] as String?,
      );
