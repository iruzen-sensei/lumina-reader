...
class EpubLoader {
  ...
  static Future<EpubBook> fromBytes(Uint8List bytes) async {
    // epubx's [EpubReader.readBook] takes the raw (still zipped) bytes and
    // handles decompression itself — passing a pre-decoded Archive is a
    // type error in this version.
