...
class MPages {
  ...
  /// Gallery-shaped result used by the interpreter backends: a page of
  /// catalog entries plus pagination info (instead of chapter images).
  MPages.gallery({
    List<MManga> mangaList = const [],
  ...
  /// Catalog entries when this [MPages] was produced by a gallery call
  /// (getPopular / getLatest / search). Empty for image page lists.
  final List<MManga> _mangaList;

  List<MManga> get mangaList => _mangaList;

  /// Whether the source has more pages after this one.
